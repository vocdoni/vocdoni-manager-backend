...
func TestRegister(t *testing.T) {
	...
	member, err := api.DB.MemberPubKey(members[0].PubKey, members[0].EntityID)
	if err != nil {
...
func TestStatus(t *testing.T) {
	...
	if err := api.DB.AddMember(members[0].EntityID, members[0].PubKey, &members[0].MemberInfo); err != nil {
